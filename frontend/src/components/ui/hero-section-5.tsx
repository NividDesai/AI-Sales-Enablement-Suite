                        ...
                        <div className="relative z-10 mx-auto flex max-w-7xl flex-col px-6 lg:block lg:px-12">
                            <div className="mx-auto max-w-lg text-center lg:ml-0 lg:max-w-full lg:text-left">
                                ...
                                <p className="mt-6 max-w-2xl text-balance text-lg text-white/70 leading-relaxed">
                                    LeadForge is your complete sales toolkit. Discover high-quality leads, enrich them with verified data, generate personalized outreach emails, and create professional documents—all powered by advanced AI.
                                </p>
